...
local settings = {
    ...
    --- Format: {condition = function, message_key = string, icon = string}
    ...
    --- Strings keys to be used whenever the player interacts with an escort mission client, depending on the job type.
...
AddDungeonSection("faultline_ridge", 0, 6, "D", 10)
AddDungeonSection("guildmaster_trail", 0, 15, "STAR_2", 30, false)
AddDungeonSection("guildmaster_trail", 0, 19, "STAR_3")
AddDungeonSection("guildmaster_trail", 0, 23, "STAR_4")
AddDungeonSection("guildmaster_trail", 0, 27, "STAR_5")
AddDungeonSection("lava_floe_island", 0, 9, "C", 16)
AddDungeonSection("lava_floe_island", 1, 1, "STAR_1", 9)
AddDungeonSection("castaway_cave", 0, 7, "B", 12)
...
AddDungeonSection("trickster_woods", 0, 6, "C", 10)
AddDungeonSection("trickster_woods", 1, 1, "B", 4)
AddDungeonSection("overgrown_wilds", 0, 7, "C", 12)
AddDungeonSection("overgrown_wilds", 1, 1, "B", 4)
AddDungeonSection("moonlit_courtyard", 0, 8, "C", 14)
AddDungeonSection("moonlit_courtyard", 0, 12, "B")
AddDungeonSection("moonlit_courtyard", 1, 1, "A", 6)
AddDungeonSection("ambush_forest", 0, 11, "B", 20)
AddDungeonSection("ambush_forest", 0, 16, "A")
AddDungeonSection("sickly_hollow", 0, 9, "S", 16, false)
...
AddDungeonSection("relic_tower", 0, 11, "STAR_1")
AddDungeonSection("sleeping_caldera", 0, 10, "B", 18)
AddDungeonSection("sleeping_caldera", 0, 15, "A")
AddDungeonSection("thunderstruck_pass", 0, 8, "B", 14)
AddDungeonSection("veiled_ridge", 0, 9, "B", 16)
AddDungeonSection("veiled_ridge", 1, 1, "A", 6)
AddDungeonSection("snowbound_path", 0, 10, "B", 18)
AddDungeonSection("snowbound_path", 1, 1, "A", 6)
AddDungeonSection("treacherous_mountain", 0, 11, "A", 20)
AddDungeonSection("treacherous_mountain", 0, 16, "S")
AddDungeonSection("champions_road", 0, 13, "S", 23)
AddDungeonSection("champions_road", 0, 19, "STAR_1")
