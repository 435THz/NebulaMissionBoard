...
local settings = {
    ...
    --- * outlaw_level: the base level of all outlaws spawned by jobs with this difficulty. If omitted, it will be equal to the dungeon's expected level.
    --- * escort_level: the level of all guests spawned by jobs with this difficulty. If omitted, it will be equal to the dungeon's expected level.
